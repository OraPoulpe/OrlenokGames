def pingpong():
    ...
    pygame.display.set_icon(pygame.image.load("./PingPong/pingpong.jpg"))
    pause = False
    ...
    while game:
        ...
        pygame.draw.rect(screen, pygame.Color("Red"), platform_right)
        pygame.draw.rect(screen, pygame.Color("Green"), platform_left)
